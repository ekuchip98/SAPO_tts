                    ...
                    <div className="widget-ft last social_footer">
                      ...
                      <div className="blocklogo">
                        <a href="a" className="logofooter">					
                          <img className="lazyload loaded" src="./images/logo/logo-footer.png" alt="logo-footer" data-was-processed="true" />					
                        </a>
                      </div>
                      ...
                      <div className="col-lg-4 col-sm-4">
                        ...
                        <div className="send-mail">
                          ...
                          <div className="icon-send">
                            <a href="a"><img src="./images/logo/facebook.png" alt="fb" /></a>
                            <a href="a"><img src="./images/logo/twtiter.png" alt="tw" /></a>
                            <a href="a"><img src="./images/logo/google.png" alt="google" /></a>
                            <a href="a"><img src="./images/logo/p.png" alt="P" /></a>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-4 col-sm-4">
